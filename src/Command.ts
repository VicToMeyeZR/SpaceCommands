...
class Command {
  private instance: SpaceCommands
  ...
  public verifyDatabaseCooldowns() {
    if (
      ...
      if (!this.instance.isDBConnected()) {
        console.warn(
          `SpaceCommands > A database connection is STRONGLY RECOMMENDED for cooldowns of 5 minutes or more.`
        )
      }
    }
  }
  ...
  public get requiredEntitlements(): string[] {
