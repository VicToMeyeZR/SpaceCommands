...
export default class SpaceCommands extends EventEmitter {
  ...
  private _componentHandler: ComponentHandler | null
  ...
  public setColor(color: string): SpaceCommands
...
// Component, Modal, and Context Menu Handler types
export {
  IButtonHandler,
  ISelectMenuHandler,
  AnySelectMenuInteraction,
  ComponentHandler,
} from './src/handlers/ComponentHandler'

export {
  IModalHandler,
  ModalHandler,
} from './src/handlers/ModalHandler'

export {
  IContextMenuCommand,
  AnyContextMenuInteraction,
  ContextMenuHandler,
} from './src/handlers/ContextMenuHandler'
...
export { InteractionCollectorUtils } from './src/utils/InteractionCollector'
